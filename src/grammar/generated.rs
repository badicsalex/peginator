// This file was generated by Peginator v0.2.3
// Hash of the grammar file: FA9EF8A0B2875DFACC150BB1F2DAF144942EE9E272D3597E3BBD3D60AE03657A
...
mod peginator_generated {
    ...
    mod StringLiteral_impl {
        ...
        pub fn rule_parser<'a>(
            ...
            let result =
                parse(state, tracer, cache)?.map(|r| super::StringLiteral { body: r.body });
            Ok(result)
        }
    }
    #[inline]
