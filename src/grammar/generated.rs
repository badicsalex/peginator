// This file was generated by Peginator v0.1.3
// Hash of the grammar file: C86719A726DB5235ADDBD10884521C76E87637427BEFC8F9CA8C9A49F36107F2
...
mod peginator_generated {
    ...
    mod PositiveLookahead_impl {
        ...
        pub fn rule_parser<'a>(
            ...
            let ok_result = parse(state, tracer, cache)?;
            Ok(ok_result.map(|r| super::PositiveLookahead { expr: r.expr }))
        }
    }
    #[inline]
